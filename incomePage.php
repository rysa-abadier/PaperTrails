<?php
    ...
    echo '<script>globalThis.currentPage = "income";</script>';
    $_SESSION["page"] = "incomePage";
?>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="card d-flex flex-row mt-5 px-2 py-4 align-items-center mx-auto" style="width: 80%; border-radius: 1rem;">
            <div class="d-flex flex-row mx-3 justify-content-center" style="width: 100%">
                <?php
            ...
            <div class="d-flex flex-row justify-content-center">
                <?php
                    echo '<div class="p-2" style="width: 80%;">';
                        echo '<h2>Income Log</h2>';

                        echo '<table class="dashboard-form mb-2">';
                            addIncome($conn);
                        echo '</table>';

                        editIncome($conn,$page, $editID);
                    echo '</div>';
                ?>
            </div>
        </div>
