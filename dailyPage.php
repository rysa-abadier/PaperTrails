<?php
    ...
    echo '<script>globalThis.currentPage = "dailyExpenses";</script>';
    $_SESSION["page"] = "dailyPage";
?>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="card d-flex flex-row mt-5 px-2 py-4 align-items-center mx-auto" style="width: 80%; border-radius: 1rem;">
            <div class="d-flex flex-row mx-3" style="width: 100%">
                <?php
